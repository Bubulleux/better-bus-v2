...
const val LAUNCH_ACTION: String = "com.bubulle.better_bus_v2.WIDGET_LAUNCH";
...
class HomeWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        appWidgetIds.forEach { widgetId ->
            ...
            val remoteAdapterIntent = Intent(context, StackWidgetService::class.java).apply {
            ...
            val pendingIntent = getActivityPendingIntent(context, null)
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_root_layout).apply {
                setRemoteAdapter(R.id.widget_list, remoteAdapterIntent)
    ...
    private fun getActivityPendingIntent(context: Context, url: String?): PendingIntent {
...
//    private lateinit var shortcutIds: Array<String>
    ...
    override fun getViewAt(position: Int): RemoteViews {
        ...
        val uri: Uri = Uri.parse("app://openShortcut/${position}")
